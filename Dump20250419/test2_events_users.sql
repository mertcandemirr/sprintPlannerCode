...
CREATE TABLE `events_users` (
  ...
  UNIQUE KEY `UK_jm8t8cul6vwamnxesijpsrkaf` (`users_id`),
  KEY `FKd46my3jbxrdmcd3m2dryyc295` (`event_id`),
  CONSTRAINT `FK2xqmgftqei5c4s82ruxl74w9a` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FKd46my3jbxrdmcd3m2dryyc295` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`)
