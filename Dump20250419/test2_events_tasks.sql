...
CREATE TABLE `events_tasks` (
  ...
  UNIQUE KEY `UK_tog91l8ackktso8r043spb536` (`tasks_id`),
...
INSERT INTO `events_tasks` VALUES (6,102),(8,53),(8,152),(103,252),(152,402),(202,352);
...
-- Dump completed on 2025-04-19 16:17:32
